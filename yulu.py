...
st.write(""" INSIGHT: """)
st.write(""" 1. Neither 'registered' or 'casual' users data follow gaussian distribution. """)
st.write(""" 2. 'humidity' or 'temp' follow somewhat of a typical distribution, although they too can't be considered normal just by looking at the visual charts.""")
...
st.pyplot(fig)
st.write(""" INSIGHT:""")
st.write(""" 1. 'Windspeed' has many outlier values, whereas 'humidity' has a few.""")
st.write(""" 2. 'temp' and 'atemp' dont seem to have any outliers.""")
st.write(""" 3. 'count', 'registered', 'casual' also have a lot of outlier values.""")
